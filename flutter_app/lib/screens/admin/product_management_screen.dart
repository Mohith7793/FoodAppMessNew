          ...
          ClipRRect(
            ...
            child: SizedBox(
              ...
              child: product.imageUrl != null
                  ? Image.network(
                      product.imageUrl!.startsWith('/uploads') ? 'http://localhost:5001${product.imageUrl}' : product.imageUrl!,
                      fit: BoxFit.cover,
                  ...
                  child: _imageBytes != null
                      ...
                      : (_existingImageUrl != null
                          ? ClipRRect(borderRadius: BorderRadius.circular(14), child: Image.network(
                              _existingImageUrl!.startsWith('/uploads') ? 'http://localhost:5001$_existingImageUrl' : _existingImageUrl!,
